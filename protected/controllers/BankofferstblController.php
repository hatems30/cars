...
class BankofferstblController extends Controller
{
	/**
...
where `user`.username= '$user_name' and controllers.controller_code_name ='$cont'";   
              ...
              if($data == NULL)
              {
                  echo 'عفوا لا توجد صلاحية للشاشة';
              }
              else 
              {
	...
	{
		$model=new Bankofferstbl;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Bankofferstbl']))
		{
			$model->attributes=$_POST['Bankofferstbl'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Bankofferstbl');
	...
	{
		$model=new Bankofferstbl('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Bankofferstbl']))
			$model->attributes=$_GET['Bankofferstbl'];
	 ...
	 * @return Bankofferstbl the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Bankofferstbl::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Bankofferstbl $model the model to be validated
	 */
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='bankofferstbl-form')
		{
