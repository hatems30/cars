...
class OutstocktblController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('Outstocktbl');
	...
	{
		$model=new Outstocktbl('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Outstocktbl']))
			$model->attributes=$_GET['Outstocktbl'];
	 ...
	 * @return Outstocktbl the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Outstocktbl::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Outstocktbl $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='outstocktbl-form')
		{
