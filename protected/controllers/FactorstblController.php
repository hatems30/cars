...
class FactorstblController extends Controller
{
	/**
	...
	{
		$model=new Factorstbl;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Factorstbl']))
		{
			$model->attributes=$_POST['Factorstbl'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->factor_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Factorstbl');
	...
	{
		$model=new Factorstbl('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Factorstbl']))
			$model->attributes=$_GET['Factorstbl'];
	 ...
	 * @return Factorstbl the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Factorstbl::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Factorstbl $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='factorstbl-form')
		{
