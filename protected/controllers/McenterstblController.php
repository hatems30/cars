...
class McenterstblController extends Controller
{
	/**
...
where `user`.username= '$user_name' and controllers.controller_code_name ='$cont'";    
	...
	{
		$model=new Mcenterstbl;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Mcenterstbl']))
		{
			$model->attributes=$_POST['Mcenterstbl'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->m_center_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Mcenterstbl');
	...
	{
		$model=new Mcenterstbl('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Mcenterstbl']))
			$model->attributes=$_GET['Mcenterstbl'];
	 ...
	 * @return Mcenterstbl the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Mcenterstbl::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Mcenterstbl $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mcenterstbl-form')
		{
