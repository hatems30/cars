...
class ComplaintstblController extends Controller
{
	/**
	...
	{
		$model=new Complaintstbl;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Complaintstbl']))
		{
			$model->attributes=$_POST['Complaintstbl'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->complaint_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Complaintstbl');
	...
	{
		$model=new Complaintstbl('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Complaintstbl']))
			$model->attributes=$_GET['Complaintstbl'];
	 ...
	 * @return Complaintstbl the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Complaintstbl::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Complaintstbl $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='complaintstbl-form')
		{
