...
class InscompsController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('Inscomps');
	...
	{
		$model=new Inscomps('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Inscomps']))
			$model->attributes=$_GET['Inscomps'];
	 ...
	 * @return Inscomps the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Inscomps::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Inscomps $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='inscomps-form')
		{
