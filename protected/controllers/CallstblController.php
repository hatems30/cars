...
class CallstblController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Callstbl']))
		{
			$model->attributes=$_POST['Callstbl'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->call_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Callstbl');
	...
	{
		$model=new Callstbl('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Callstbl']))
			$model->attributes=$_GET['Callstbl'];
	 ...
	 * @return Callstbl the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Callstbl::model()->findByPk($id);
		if($model===null)
