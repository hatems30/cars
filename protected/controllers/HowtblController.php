...
class HowtblController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Howtbl']))
		{
			$model->attributes=$_POST['Howtbl'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->how_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Howtbl');
	...
	{
		$model=new Howtbl('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Howtbl']))
			$model->attributes=$_GET['Howtbl'];
	 ...
	 * @return Howtbl the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Howtbl::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Howtbl $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='howtbl-form')
		{
