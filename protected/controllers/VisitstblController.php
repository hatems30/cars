...
class VisitstblController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Visitstbl']))
		{
			$model->attributes=$_POST['Visitstbl'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Visitstbl');
	...
	{
		$model=new Visitstbl('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Visitstbl']))
			$model->attributes=$_GET['Visitstbl'];
	 ...
	 * @return Visitstbl the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Visitstbl::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Visitstbl $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='visitstbl-form')
		{
