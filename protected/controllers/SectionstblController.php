...
class SectionstblController extends Controller
{
	/**
	...
	{
		$model=new Sectionstbl;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Sectionstbl']))
		{
			$model->attributes=$_POST['Sectionstbl'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Sectionstbl');
	...
	{
		$model=new Sectionstbl('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Sectionstbl']))
			$model->attributes=$_GET['Sectionstbl'];
	 ...
	 * @return Sectionstbl the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Sectionstbl::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Sectionstbl $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='sectionstbl-form')
		{
