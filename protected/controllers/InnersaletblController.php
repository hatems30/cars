...
class InnersaletblController extends Controller
{
	/**
	...
	{
		$model=new Innersaletbl;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Innersaletbl']))
		{
			$model->attributes=$_POST['Innersaletbl'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->trs_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Innersaletbl');
	...
	{
		$model=new Innersaletbl('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Innersaletbl']))
			$model->attributes=$_GET['Innersaletbl'];
	 ...
	 * @return Innersaletbl the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Innersaletbl::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Innersaletbl $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='innersaletbl-form')
		{
