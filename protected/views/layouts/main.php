...
<body>
	...
	<div id="header">
		...
		<div id="logo"><?php echo CHtml::encode(Yii::app()->name); ?></div>
                ...
                <div dir = rtl  id="logo"><font face="andalus">المحاسب لمعارض السيارات</font></div>
                </div>
            </div>
	</div><!-- header -->
<!---------------------------------------------------------------------------------------------------------------->
    ...
    <div>
        ...
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><b>Reports</b><span class="caret"></span></a>            
          <ul class="dropdown-menu" alig="center">
            ...
            <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=employeesalesreport/view"><b>تقرير مبيعات مندوب </b></a></li>   
          </ul>            
        </li>  
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><b>Customer Service</b><span class="caret"></span></a>            
          <ul class="dropdown-menu" alig="center">
             <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=callstbl/admin&view=admin">تسجيل المكالمات</a></li>    
             <li><a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php?r=managecalls/view">المكالمات الواردة</a></li>
          </ul>            
        </li> 
