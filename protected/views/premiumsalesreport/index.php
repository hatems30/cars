<div class="panel panel-default">
    <div class="panel-heading" dir =rtl>
        <div class="row">
            <div class="col-sm-7"><b><font size="5" color="blue">تقرير مبيعات القسط المباشر</font></b></div>                          
        </div>
    </div>
...
<script type ="text/javascript">
          ...
          $('#mybutton').on('click',function(){
            ...
            //alert ($('#date_from').val());
              ...
              $.ajax({
                  url: "<?php echo Yii::app()->request->baseUrl; ?>/"+"index.php?r=Premiumsalesreport/Getdata",
