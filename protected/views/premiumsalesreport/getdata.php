<?php 
    ...
    'columns'=>array(                                                                
                     ...
                     array('name'=>'مسلسل', 'type' => 'raw' , 'value'=> '$data[\'downpayment\']'), 
                     array('name'=>'التاريخ', 'type' => 'raw' , 'value'=> '$data[\'invoice_date\']'),         
                     array('name'=>'الماركة', 'type' => 'raw' , 'value'=> '$data[\'monthly_premium\']'), 
                     array('name'=>'الموديل', 'type' => 'raw' , 'value'=> '$data[\'months_count\']'), 
                     array('name'=>'رقم الشاسيه', 'type' => 'raw' , 'value'=> '$data[\'interest_rate\']'),      
