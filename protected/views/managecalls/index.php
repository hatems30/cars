<div class="panel panel-default">
    <div class="panel-heading" dir =rtl>
        <div class="row">
            <div class="col-sm-6"><b><font size="5" color="blue">متابعة المكالمات الواردة</font></b></div>                          
        </div>
    </div>
...
<script type ="text/javascript">
         ...
         // alert ($('#branchs').val());
              ...
              $.ajax({
                  url: "<?php echo Yii::app()->request->baseUrl; ?>/"+"index.php?r=Managecalls/Getdata",
                  data:{"employee_id":$('#employees').val() ,"date_from":$('#date_from').val() ,"date_to":$('#date_to').val()},
                  method:'POST',
