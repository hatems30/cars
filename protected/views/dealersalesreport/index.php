<div class="panel panel-default">
    <div class="panel-heading" dir =rtl>
        <div class="row">
            <div class="col-sm-6"><b><font size="5" color="blue">تقرير مبيعات التجاري</font></b></div>                          
        </div>
    </div>
    ...
    <div class="container-fluid">         
        <div class ="row">
            ...
            <div class ="col-sm-3">
                ...
                <div class ="col-sm-3">
                     <?php
                         $models =  Dealerstbl::model()->findAll(array('order' => 'dealer_name'));
                         $list = CHtml::listData($models, 'dealer_id', 'dealer_name');
                         echo CHtml::dropDownList('dealers', $models, $list,array('empty' => '' , 'class'=>'form-control')); 
                      ?>
                </div>    
                   </br>
          </div>
...
<script type ="text/javascript">
         ...
         //alert ($('#dealers').val());
              ...
              $.ajax({
                  url: "<?php echo Yii::app()->request->baseUrl; ?>/"+"index.php?r=Dealersalesreport/Getdata",
                  data:{"id":$('#branchs').val(),"dealer_id":$('#dealers').val() ,"date_from":$('#date_from').val() ,"date_to":$('#date_to').val()},
                  method:'POST',
