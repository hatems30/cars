...
<script type ="text/javascript">
             ...
             $(function(){    
                 ...
                 $('#Salestbl_discount').on('change',function(){     
                       if ($('#Salestbl_finance_type').val()==="نقدي")
                       {
                          document.getElementById('Salestbl_final_price').value =  $('#Salestbl_cach_price').val() - (($('#Salestbl_discount').val()/100)*$('#Salestbl_cach_price').val());    
                       }
                       else if ($('#Salestbl_finance_type').val() === "قسط مباشر")
                       {
                           
                          document.getElementById('Salestbl_final_price').value =  $('#Salestbl_premium_price').val() - (($('#Salestbl_discount').val()/100)*$('#Salestbl_premium_price').val());      
                       }
                       else if ($('#Salestbl_finance_type').val() === "بنك")
                       {
                          document.getElementById('Salestbl_final_price').value =  $('#Salestbl_bank_price').val() - (($('#Salestbl_discount').val()/100)*$('#Salestbl_bank_price').val());                                 
                       }
                 });
