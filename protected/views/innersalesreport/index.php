...
<div class="panel panel-default">
    <div class="panel-heading" dir =rtl>
        <div class="row">
            <div class="col-sm-7"><b><font size="5" color="blue">تقرير التحويلات بين الفروع</font></b></div>                          
        </div>
    </div>
...
<script type ="text/javascript">     
          ...
          $('#mybutton').on('click',function(){                
              $.ajax({
                  url: "<?php echo Yii::app()->request->baseUrl; ?>/"+"index.php?r=innersalesreport/Getdata",
