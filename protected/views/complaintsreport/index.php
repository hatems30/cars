<div class="panel panel-default">
    <div class="panel-heading" dir =rtl>
        <div class="row">
            <div class="col-sm-7"><b><font size="5" color="blue">تقرير الشكاوى  </font></b></div>                          
        </div>
    </div>
         ...
         <div class="container-fluid">         
                <div class ="row">
                    ...
                    <div class ="col-sm-3">
                             ...
                             $models = Employees::model()->findall();
...
<script type ="text/javascript">
         ...
         // alert ($('#branchs').val());
              ...
              $.ajax({
                  url: "<?php echo Yii::app()->request->baseUrl; ?>/"+"index.php?r=Complaintsreport/Getdata",
                  data:{"id":$('#branchs').val() ,"employee_id":$('#employees').val() ,"start_date":$('#date_from').val() ,"end_date":$('#date_to').val()},
                  method:'POST',
