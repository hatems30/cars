<div class="panel panel-default">
    <div class="panel-heading" dir =rtl>
        <div class="row">
            <div class="col-sm-8"><b><font size="5" color="blue">تقرير باجمالي المبيعات خلال فترة</font></b></div>                          
        </div>
    </div>
...
<script type ="text/javascript">
          ...
          $('#mybutton').on('click',function(){                                                     
              $.ajax({
                  url: "<?php echo Yii::app()->request->baseUrl; ?>/"+"index.php?r=Allsalesreport/Getdata",
