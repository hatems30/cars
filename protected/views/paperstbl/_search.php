...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'paper_date'); ?>
		<?php echo $form->textField($model,'paper_date'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'paper_status'); ?>
		<?php echo $form->textField($model,'paper_status',array('size'=>50,'maxlength'=>50)); ?>
	</div>
